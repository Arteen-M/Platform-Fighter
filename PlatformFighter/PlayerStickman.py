...
class PlayerStickman(pygame.sprite.Sprite):
    ...
    def special_attack(self, special_button, left_button, right_button, up_button, down_button):
        ...
        if pressed_keys[special_button] and (pressed_keys[left_button] or pressed_keys[right_button]) \
                and self.numHitstun <= 0 and not self.in_lag:
        ...
        elif pressed_keys[special_button] and pressed_keys[up_button] and self.numHitstun <= 0 and not self.in_lag:
        ...
        elif pressed_keys[special_button] and pressed_keys[down_button] and self.numHitstun <= 0 and not self.in_lag:
            if self.on_ground:
            ...
            special_button] and self.numHitstun <= 0 and not self.in_lag and self.projectile_active <= 0 and self.projectile_active_left <= 0:
    ...
    def strong_attacks(self, strong_key, up_key, down_key):
        ...
        if ((pressed_keys[strong_key] and pressed_keys[up_key]) and not (self.in_lag or self.is_shielding)
            and self.on_ground) or (pressed_keys[strong_key] and (self.in_up_strong_right > 0 or
                                                                  self.in_up_strong_left > 0) and
                                    self.num_rotations <= 24 and self.on_ground):
            if self.direction:
                self.num_lag = 2
              ...
              and self.on_ground) or (pressed_keys[strong_key] and self.in_down_strong > 0 and
                                      self.num_rotations <= 12 and self.on_ground):
            self.num_lag = 2
            ...
            if self.in_down_strong == 21:
                ...
                (pressed_keys[strong_key] and (self.in_f_strong_right > 0 or self.in_f_strong_left > 0) and
                 self.num_rotations <= 4 and self.on_ground):
            if self.direction:
                self.num_lag = 2
